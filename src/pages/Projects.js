...
export function Projects() {
    ...
    return (
        <div className="flex flex-col p-[30px] w-[100%] min-h-[100vh] sm:p-[40px] lg:p-[60px] xl:p-[80px] overflow-hidden">
            ...
            <div className="m-auto w-[100%] md:w-[40rem] lg:w-[45rem] xl:w-[60rem]" data-aos="fade-up" data-aos-duration="1000">
                ...
                <Carousel selectedItem={9} infiniteLoop={true} showThumbs={false} showStatus={false}>
                    {repositories?.map(repo => (
                        <a
                            ...
                            target="_blank"
                            rel="noreferrer"
                            className="flex justify-center items-center h-[15rem] sm:h-[20rem] md:h-[25rem] lg:h-[28rem] xl:h-[33rem] text-[1.8rem] font-bold bg-[#222]"

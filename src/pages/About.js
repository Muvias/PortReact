export function About() {
    return (
        <div className="flex flex-col w-[100%] min-h-[100vh] lg:p-[100px] bg-black" id="about">
            ...
            <div className="flex flex-col justify-center items-center p-[30px] lg:flex-row lg:justify-between lg:mt-[40px] lg:p-[0] lg:items-start">
                <div className="text-center text-[#fff] lg:min-w-[49%] lg:w-[49%]" data-aos="fade-right" data-aos-duration="2000">
                    <p className="mb-[20px] lg:mt-[20px] text-[1.1em] text-left">

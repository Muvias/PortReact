export function About() {
    return (
        <div className="flex flex-col w-[100%] min-h-[100vh] p-[100px] bg-black" id="about">
            <div className="text-center text-[#fff]" data-aos="fade-down" data-aos-duration="1000">
            ...
            <div className="flex justify-between mt-[40px]">
                <div className="text-center text-[#fff] min-w-[49%] w-[49%]" data-aos="fade-right" data-aos-duration="2000">
                ...
                <div className="ml-[40px]" data-aos="fade-left" data-aos-duration="2000">
                    <img
